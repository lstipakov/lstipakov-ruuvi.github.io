...
The Tinker section of the Ruuvi mobile app makes it very easy to start playing with your Particle device without writing any code. It's great for early development, learning, and prototyping. We'll learn to use it in the next few examples.
...
* **Hardware**
  ...
  * (1) Photoresistor or other resistance-based sensor, such as a Thermistor or Force-Sensitive Resistor {{#if ruuvitag}}(Photoresistor included with RuuviTag Kit and Maker Kit){{/if}}
* **Software**
  * Ruuvi Mobile App - [iPhone](https://itunes.apple.com/us/app/ruuvi-build-ruuvitag-electron/id991459054?ls=1&mt=8) | [Android](https://play.google.com/store/apps/details?id=io.particle.android.app) (requires Android 4.0.3 or higher)
* **Experience**
    * Connecting your Device [with your smartphone](/guide/getting-started/start) or [over USB](/guide/getting-started/connect)

{{#if ruuvitracker}}**NOTE:** You may already have the Spark RuuviTracker App for [iPhone](https://itunes.apple.com/us/app/spark-ruuvitracker/id760157884) or [Android](https://play.google.com/store/apps/details?id=io.spark.core.android) (requires Android 4.0 or higher). We recommend getting the newer Ruuvi Mobile App anyway, since it's a very nice interface for Tinker that works across all devices. Sadly, the new Particle Mobile App will not connect your Core, though. If you don't feel like having two apps on your phone, the old Spark Core App will still work for these examples. However, the images in this tutorial will be from the newer and fancier Particle App.{{/if}}

## Step One: Select Your Device

You've already connected your device, either with [your smartphone](/guide/getting-started/start) or [over USB](/guide/getting-started/connect). This means that when you open the Ruuvi App, you'll see a screen like this:
...
![LED fritzing](/assets/images/ruuvitag-led-fritzing.png)
...
![One Wire Fritzing](/assets/images/ruuvitag-onewire-fritzing.png)
...
![Photoresistor Only Fritzing](/assets/images/ruuvitag-photores-only-fritzing.png)
...
When you're ready, let's move on to [putting your own firmware on your Ruuvi device using the web IDE.](/guide/getting-started/build)
