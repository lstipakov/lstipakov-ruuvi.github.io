...
The [Dashboard](https://dashboard.ruuvi.io) is a new feature we're working on to improve the developer experience of building connected products with Ruuvi. It's currently in alpha, which means we'll be working on it and releasing frequent updates.
...
[Talk to us on the Community!](http://community.ruuvi.io/t/fleet-management-dashboard-alpha-run-feedback/11118)
...
The Devices page allows you to see a list of the devices registered to your account. Here, you can see specific information about each device, including it's unique Device ID, it's name, the last time it connected to the Ruuvi cloud, and whether or not the device is currently online.
