...
(function($) {
  ...
  Docs.rememberDevices = function() {
    if(typeof(Storage) !== "undefined") {
      ...
      if(currentPath.indexOf("ruuvitag") > -1) {
        localStorage.setItem("lastDevice", "ruuvitag");
      } else if (currentPath.indexOf("ruuvitracker") > -1) {
        localStorage.setItem("lastDevice", "ruuvitracker");
      }
    }
  };
